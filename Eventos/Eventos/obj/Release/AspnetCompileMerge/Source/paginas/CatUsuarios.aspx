<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/SiteMaster.Master" AutoEventWireup="true" CodeBehind="CatUsuarios.aspx.cs" Inherits="veamosmty.paginas.CatUsuarios" %>

<%@ Import Namespace="veamosmty.Data" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/pages/CatUsuarios.js?<% = Sezzion.codigoSession %>"></script>
</asp:Content>

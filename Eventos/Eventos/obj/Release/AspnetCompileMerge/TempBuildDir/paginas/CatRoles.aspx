<%@ Page Title="" Language="C#" MasterPageFile="~/paginas/SiteMaster.Master" AutoEventWireup="true" CodeBehind="CatRoles.aspx.cs" Inherits="veamosmty.paginas.CatRoles" %>
<%@ Import Namespace="veamosmty.Data" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="../js/pages/CatRoles.js?<% = Sezzion.codigoSession %>"></script>
</asp:Content>
